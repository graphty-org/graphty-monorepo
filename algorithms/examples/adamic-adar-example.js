...
sizes.forEach((size) => {
    ...
    console.log(
        `  Average score: ${(Array.from(predictions.values()).reduce((a, b) => a + b, 0) / predictions.size).toFixed(3)}`,
    );
});
...
console.log("\n=== Verification ===");
console.log(
    "✓ Adamic-Adar gives lower weight to high-degree neighbors:",
...
console.log(
    "✓ Score is sum of 1/log(degree) for common neighbors:",
...
console.log("✓ High-degree nodes contribute less:", 1 / Math.log(10) < 1 / Math.log(3));
