...
// Verify results
console.log("\n=== Verification ===");
console.log("✓ Should find 5 components in original graph:", components.length === 5);
console.log("✓ Union-Find and DFS should give same number of components:", components.length === componentsDFS.length);
console.log("✓ Graph should not be connected (multiple components):", !connected);
console.log("✓ Largest component should be size 4 (Grace-Henry-Ivy-Jack):", largest.length === 4);
console.log("✓ Sum of component sizes should equal total nodes:", totalNodes === graph.nodeCount);
console.log("✓ Fully connected graph should have 1 component:", connectedComponents2.length === 1);
console.log("✓ Empty graph should have 0 components:", emptyComponents.length === 0);
console.log("✓ Single node should have 1 component:", singleComponents.length === 1);
console.log("✓ Adding bridge should reduce number of components:", bridgedComponents.length < components.length);
...
console.log("✓ All nodes should appear in exactly one component:", allNodesInComponents.size === graph.nodeCount);

// Verify specific component memberships
console.log(
    "✓ Alice should be with Bob and Charlie:",
    aliceComponent.includes("Bob") && aliceComponent.includes("Charlie"),
);
console.log(
    "✓ David should be with Eve and Frank:",
