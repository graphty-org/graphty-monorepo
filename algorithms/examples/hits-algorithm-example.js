...
for (let i = 0; i < 5; i++) {
    console.log(
        `  ${i + 1}  | ${(topHubs[i] || "").padEnd(17)} | ${(topAuthorities[i] || "").padEnd(17)} | ${topPageRank[i] || ""}`,
    );
}
...
// Verify results
console.log("\n=== Verification ===");
console.log("✓ TechNewsHub should be a top hub:", topHubs.includes("TechNewsHub"));
console.log("✓ MIT_AI_Lab should be a top authority:", topAuthorities.includes("MIT_AI_Lab"));
console.log(
...
console.log(
    "✓ Sum of squared hub scores should be ~1:",
    Math.abs(Object.values(hitsScores.hubs).reduce((sum, s) => sum + s * s, 0) - 1) < 0.01,
);
console.log(
    "✓ Sum of squared authority scores should be ~1:",
