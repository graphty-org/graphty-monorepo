...
export function testBasicIsomorphism() {
    ...
    triangle1.addNode("2");
    triangle1.addNode("3");
    triangle1.addEdge("1", "2");
    triangle1.addEdge("2", "3");
    triangle1.addEdge("3", "1");

    // Triangle 2: nodes A, B, C (same structure)
    triangle2.addNode("A");
    triangle2.addNode("B");
    triangle2.addNode("C");
    triangle2.addEdge("A", "B");
    triangle2.addEdge("B", "C");
    triangle2.addEdge("C", "A");
...
export function testComplexIsomorphism() {
    ...
    // Left triangle
    bowtie1.addEdge("left1", "left2");
    bowtie1.addEdge("left2", "center");
    bowtie1.addEdge("center", "left1");
    // Right triangle
    bowtie1.addEdge("center", "right1");
    bowtie1.addEdge("right1", "right2");
    bowtie1.addEdge("right2", "center");
...
export function testChemicalStructures() {
    ...
    butane.addEdge("C1", "C2");
    butane.addEdge("C2", "C3");
    butane.addEdge("C3", "C4");
    ...
    isobutane.addEdge("C1", "C2");
    isobutane.addEdge("C2", "C3");
    isobutane.addEdge("C2", "C4");
...
export function testEdgeCases() {
    ...
    // Single node graphs
    const single1 = new Graph();
    single1.addNode("A");
    const single2 = new Graph();
    single2.addNode("X");
    ...
    disconnected1.addEdge("A", "B");
    disconnected1.addEdge("C", "D");

    const disconnected2 = new Graph();
    ["1", "2", "3", "4"].forEach((node) => disconnected2.addNode(node));
    disconnected2.addEdge("1", "2");
    disconnected2.addEdge("3", "4");
