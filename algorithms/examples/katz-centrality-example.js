...
people.forEach((person) => {
    console.log(
        `${person.padEnd(7)} | ${katzStandard[person].toFixed(4).padEnd(12)} | ${katzPersonalized[person].toFixed(4)}`,
    );
});
...
console.log("\n=== Verification ===");
console.log(
    "✓ CEO should have highest Katz centrality in org network:",
...
console.log(
    "✓ Higher alpha should give more weight to distant connections:",
    katzCentrality(orgNetwork, { alpha: 0.2 })["Engineer1"] > katzCentrality(orgNetwork, { alpha: 0.05 })["Engineer1"],
);
console.log("✓ Personalized Katz should favor the biased node:", katzPersonalized["Alice"] > katzStandard["Alice"]);
