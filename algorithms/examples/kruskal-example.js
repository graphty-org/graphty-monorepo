...
console.log(
    `MST edges: ${mst2.edges.length}, Total weight: ${Array.from(mst2.edges).reduce((sum, e) => sum + (e.weight || 0), 0)}`,
);
...
// Verify results
console.log("\n=== Verification ===");
console.log("✓ MST should have n-1 edges for n nodes:", mstEdges.length === graph.nodeCount - 1);
console.log("✓ MST should be connected (spanning):", mst.nodeCount === graph.nodeCount);
console.log("✓ Small graph MST should have 2 edges:", smallMST.edges.length === 2);
console.log(
    "✓ Small graph MST weight should be 3 (1+2):",
    Array.from(smallMST.edges).reduce((sum, e) => sum + (e.weight || 0), 0) === 3,
);
console.log("✓ Equal weights MST should have 3 edges:", equalMST.edges.length === 3);
console.log("✓ MST and alias should produce same result:", mst.edges.length === mst2.edges.length);
