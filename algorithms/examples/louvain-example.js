...
// Verify results
console.log("\n=== Verification ===");
console.log("✓ Basic result should find 3 communities:", result.communities.length === 3);
console.log("✓ Modularity should be positive for good community structure:", result.modularity > 0);
console.log(
...
console.log(
    "✓ Lower resolution should find fewer communities:",
...
console.log(
    "✓ Good communities should have more within than between edges:",
