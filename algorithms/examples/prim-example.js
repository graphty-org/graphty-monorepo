...
const eastsideCost = Array.from(mstFromEastside.edges).reduce((sum, e) => sum + (e.weight || 0), 0);
...
// Verify results
console.log("\n=== Verification ===");
console.log("✓ MST should have n-1 edges for n nodes:", edges.length === cityGraph.nodeCount - 1);
console.log("✓ MST should span all nodes:", mstFromDowntown.nodeCount === cityGraph.nodeCount);
console.log("✓ Different starting points give same total weight:", totalCost === eastsideCost);
console.log(
    "✓ Triangle MST should have weight 3 (1+2):",
    Array.from(triangleMST.edges).reduce((sum, e) => sum + (e.weight || 0), 0) === 3,
);
console.log(
    "✓ Step MST should have minimum total weight:",
