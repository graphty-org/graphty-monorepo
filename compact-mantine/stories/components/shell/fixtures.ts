/**
 * Sample tools, rail destinations, shortcuts and actions for the App shell stories. The glyphs
 * are lucide's (no JSX here, so the file lints as a plain .ts module), drawn at 18px with a 1px
 * stroke to sit in the 24px icon box the way Figma's do; an app brings its own.
 */
import {
    AlignCenterVertical,
    AlignEndVertical,
