...
| [`decisions/`](decisions/) | Decision records: one decision per file, never edited after it lands | 10 |
...
| [`webgpu/`](webgpu/) | WebGPU-accelerated graph algorithms and layouts: the accepted design, the P0-P3 contract and phase plans, the monorepo integration plan | 12 |
