...
```ts
        { name: "attains-is-le", find: "tight = (dv != F32_INF_BITS) && (bitcast<u32>(bitcast<f32>(du) + w) == dv);", replace: "tight = (dv != F32_INF_BITS) && (bitcast<u32>(bitcast<f32>(du) + w) <= dv);", minFactor: 10, test: SSSP_TEST },
