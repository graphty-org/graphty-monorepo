...
const positions = [
    ...
    base,
    -width / 2,
    0, // Bottom corner (at base)
    base,
    width / 2,
    0, // Top corner (at base)
];
...
const positions = [
    ...
    0,
    halfWidth,
    0, // Top-right at origin (front)
    0,
    -halfWidth,
    0, // Bottom-right at origin (front)
    -length,
    -halfWidth,
    0, // Bottom-left (back)
];
...
class EdgeBatchRenderer {
    ...
    createBatch(edges: Edge[], style: EdgeStyle): Mesh {
        ...
        const geometries = edges.map((e) => CustomLineRenderer.createLineGeometry([e.src, e.dst]));
...
- `test/meshes/CustomLineArrows.test.ts`: Test arrow geometry generation with CustomLineRenderer
    ...
    describe("CustomLineRenderer Arrow Geometry", () => {
        ...
        test("arrow mesh uses same shader as line mesh", () => {
            ...
            const arrowMesh = CustomLineRenderer.createFromGeometry(arrowGeom, { width: 1.0, color: "#FF0000" }, scene);
...
- `test/Edge.arrowText.test.ts`: Test arrow text labels
    ...
    describe("Arrow Text Labels", () => {
        ...
        test("arrow labels position near arrow heads", () => {
            ...
            const distance = Vector3.Distance(edge.arrowHeadLabel.position, edge.arrowMesh.position);
