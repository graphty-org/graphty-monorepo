...
const LayoutTypeSchema = z
    .string()
    .describe("Layout algorithm type (e.g., 'circular', 'ngraph', 'random', 'spiral', 'd3')");
...
export const setDimension: GraphCommand = {
    name: "setDimension",
    description:
        "Switch between 2D and 3D graph visualization modes. In 2D mode, nodes are arranged on a flat plane. In 3D mode, nodes can be positioned in three-dimensional space.",
    parameters: z.object({
