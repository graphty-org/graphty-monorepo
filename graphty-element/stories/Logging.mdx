...
```typescript
import { GraphtyLogger, LogLevel, configureLogging, getLoggingConfig } from "@graphty/graphty-element";
...
```typescript
import { saveLoggingConfig, loadLoggingConfig, clearLoggingConfig, getLoggingConfig } from "@graphty/graphty-element";
