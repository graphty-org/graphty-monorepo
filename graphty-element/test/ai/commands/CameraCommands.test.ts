...
import { setCameraPosition, zoomToNodes } from "../../../src/ai/commands/CameraCommands";
...
describe("CameraCommands", () => {
    ...
    describe("setCameraPosition", () => {
        it("applies camera preset 'top'", async () => {
            ...
            assert.ok(result.message.toLowerCase().includes("camera") || result.message.toLowerCase().includes("top"));
        });
        ...
        it("handles animation option", async () => {
            const resultAnimated = await setCameraPosition.execute(
                graph,
                {
                    preset: "topView",
                    animate: true,
            ...
            const resultImmediate = await setCameraPosition.execute(
                graph,
                {
                    preset: "topView",
                    animate: false,
