...
describe("Simple Real Mesh Tests", () => {
    ...
    describe("NodeMesh Coverage", () => {
        ...
        test("creates all 27 node shapes", () => {
            const shapes = [
                // Basic shapes
                "box",
                "sphere",
