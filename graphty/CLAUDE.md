...
- This project uses Mantine for its UI framework

## Development Notes

- We may be testing from mobile. Always include eruda in our UI so that we can see the console.log messages.
