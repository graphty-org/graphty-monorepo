...
export const figmaTheme = createTheme({
  ...
  colors: {
    ...
    blue: [
      ...
      '#339AF0', '#0D99FF', '#1C7ED6', '#1971C2', '#1864AB',
    ],
  },
      ...
      <ScrollArea h="100%">
        <Stack gap="xs" p="xs">
          ...
          <ControlSection
            ...
            actions={<ActionIcon><IconPlus size={14} /></ActionIcon>}
            defaultExpanded={true}
          >
            ...
            <ControlGroup
              ...
              actions={
                <>
                  <ActionIcon><IconGrid size={14} /></ActionIcon>
                  <ActionIcon><IconPlus size={14} /></ActionIcon>
                </>
              }
            >
              <PropertyRow color="#FFFFFF" opacity={100} selected />
          ...
          >
            ...
            <ControlGroup name="Arrow">
              <Select
                data={['None', 'Arrow', 'Circle', 'Diamond']}
                defaultValue="Arrow"
              />
            </ControlGroup>
          </ControlSection>
