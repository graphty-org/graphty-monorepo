 ...
 * @param root0.label - Label prefix for the arrow control (e.g., "Head" or "Tail")
 * @param root0.value - The current arrow configuration
 * @param root0.onChange - Called when the arrow configuration changes
 * @returns The edge arrow control component
 */
