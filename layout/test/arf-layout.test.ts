...
describe("ARF Layout", () => {
    ...
    describe("Initial positions", () => {
        ...
        it("should generate random initial positions if not provided", () => {
            ...
            graph.nodes().forEach((node) => {
                if (
                    Math.abs(positions1[node][0] - positions2[node][0]) > 0.01 ||
    ...
    describe("Force parameters", () => {
        ...
        it("should respect maxIter parameter", () => {
            ...
            const positions1 = arfLayout(graph, null, 1, 1.2, 10, 42);

            // Test with more iterations
            const positions2 = arfLayout(graph, null, 1, 1.2, 1000, 42);
            ...
            const positions2a = arfLayout(graph, null, 1, 1.2, 1000, 42);
            const positions2b = arfLayout(graph, null, 1, 1.2, 1000, 42);
