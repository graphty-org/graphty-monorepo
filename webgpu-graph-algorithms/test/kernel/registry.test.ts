...
const TABLE: Readonly<Record<KernelId, ExpectedEntry>> = {
    ...
    "indirect-finalize": {
        ...
        bindings: [
            [1, 0, "counters", "storage-ro", "array<u32>"],
            [1, 1, "args", "storage", "array<u32>"],
            [2, 0, "P", "uniform", "IndirectParams"],
        ],
        overrideDecls: [],
    ...
    "scan-block": {
        ...
        bindings: [
            [1, 0, "src", "storage-ro", "array<u32>"],
            [1, 1, "out", "storage", "array<u32>"],
            [1, 2, "blockSums", "storage", "array<u32>"],
            [2, 0, "P", "uniform", "ScanParams"],
        ],
        overrideDecls: [],
    ...
    "scan-add": {
        ...
        bindings: [
            [1, 0, "out", "storage", "array<u32>"],
            [1, 1, "blockOffsets", "storage-ro", "array<u32>"],
            [2, 0, "P", "uniform", "ScanParams"],
        ],
        overrideDecls: [],
        uniforms: [SCAN_PARAMS],
    ...
    histogram: {
        ...
        bindings: [
            [1, 0, "keys", "storage-ro", "array<u32>"],
            [1, 1, "hist", "storage", "array<atomic<u32>>"],
            [2, 0, "P", "uniform", "HistParams"],
        ],
        overrideDecls: [],
    ...
    "counting-scatter": {
        ...
        bindings: [
            [1, 0, "keys", "storage-ro", "array<u32>"],
            [1, 1, "start", "storage-ro", "array<u32>"],
            [1, 2, "cursor", "storage", "array<atomic<u32>>"],
            [1, 3, "outIndex", "storage", "array<u32>"],
            [2, 0, "P", "uniform", "HistParams"],
        ],
        overrideDecls: [],
        uniforms: [HIST_PARAMS],
    ...
    "radix-scatter": {
        ...
        bindings: [
            [1, 0, "keys", "storage-ro", "array<u32>"],
            [1, 1, "vals", "storage-ro", "array<u32>"],
            [1, 2, "offsets", "storage-ro", "array<u32>"],
            [1, 3, "keysOut", "storage", "array<u32>"],
            [1, 4, "valsOut", "storage", "array<u32>"],
            [2, 0, "P", "uniform", "RadixParams"],
        ],
        overrideDecls: [],
        uniforms: [RADIX_PARAMS],
    ...
    "grid-cell-key": {
        ...
        bindings: [
            [1, 0, "pos", "storage-ro", "array<vec4f>"],
            [1, 1, "S", "storage-ro", "Fa2State"],
            [1, 2, "cellKey", "storage", "array<u32>"],
            [1, 3, "cellVal", "storage", "array<u32>"],
            [2, 0, "P", "uniform", "Fa2Params"],
        ],
        overrideDecls: [],
    ...
    "grid-centroid": {
        ...
        bindings: [
            [1, 0, "sortedIdx", "storage-ro", "array<u32>"],
            [1, 1, "cellStart", "storage-ro", "array<u32>"],
            [1, 2, "pos", "storage-ro", "array<vec4f>"],
            [1, 3, "pyramid", "storage", "array<vec4f>"],
            [1, 4, "hubList", "storage", "array<u32>"],
            [1, 5, "hubCounters", "storage", "array<atomic<u32>>"],
            [2, 0, "P", "uniform", "Fa2Params"],
        ],
        overrideDecls: [],
        uniforms: [FA2_PARAMS],
    ...
    "grid-centroid-hub": {
        ...
        bindings: [
            ...
            [1, 2, "pos", "storage-ro", "array<vec4f>"],
            [1, 3, "pyramid", "storage", "array<vec4f>"],
            [1, 4, "hubList", "storage-ro", "array<u32>"],
            [1, 5, "hubCount", "storage-ro", "array<u32>"],
            [2, 0, "P", "uniform", "Fa2Params"],
        ],
        overrideDecls: [],
        uniforms: [FA2_PARAMS],
    ...
    "grid-downsample": {
        ...
        bindings: [
            [1, 0, "pyramid", "storage", "array<vec4f>"],
            [2, 0, "P", "uniform", "GridLevelParams"],
        ],
        overrideDecls: [],
    ...
    "grid-far-field": {
        ...
        bindings: [
            [1, 0, "pos", "storage-ro", "array<vec4f>"],
            [1, 1, "sortedIdx", "storage-ro", "array<u32>"],
            [1, 2, "pyramid", "storage-ro", "array<vec4f>"],
            [1, 3, "S", "storage-ro", "Fa2State"],
            [1, 4, "force", "storage", "array<f32>"],
            [2, 0, "P", "uniform", "Fa2Params"],
        ],
        overrideDecls: [["LAW", "u32", 0]],
        uniforms: [FA2_PARAMS, FA2_STATE],
        needs: [],
        snippetSlots: [],
        phase: "P4",
    ...
    "grid-near-field": {
        ...
        bindings: [
            [1, 0, "pos", "storage-ro", "array<vec4f>"],
            [1, 1, "sortedIdx", "storage-ro", "array<u32>"],
            [1, 2, "cellStart", "storage-ro", "array<u32>"],
            [1, 3, "S", "storage", "Fa2State"],
            [1, 4, "force", "storage", "array<f32>"],
            [1, 5, "oldForce", "storage-ro", "array<f32>"],
            [1, 6, "fixedMask", "storage-ro", "array<u32>"],
            [1, 7, "partials", "storage", "array<Fa2Partial>"],
            [2, 0, "P", "uniform", "Fa2Params"],
        ],
        overrideDecls: [
            ["SWING_MODE", "u32", 0],
    ...
    "bfs-bottom-up": {
        ...
        bindings: withGraph([
            [1, 0, "sweepIn", "storage-ro", "array<u32>"],
            [1, 1, "counters", "storage", "array<atomic<u32>>"],
            [1, 2, "depth", "storage", "array<atomic<u32>>"],
            [1, 3, "frontierOut", "storage", "array<u32>"],
            [2, 0, "P", "uniform", "FrontierParams"],
